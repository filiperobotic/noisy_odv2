...
custom_imports = dict(
    imports=['custom_configs.hooks.vcnc_fine_kmeans_spatial_hook',
...
custom_hooks = [
    dict(
    type='VCNCFineKMeansSpatialHook',
