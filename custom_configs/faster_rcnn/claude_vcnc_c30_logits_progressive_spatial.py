...
custom_imports = dict(
    imports=['custom_configs.hooks.vcnc_complete_with_spatial_hook',
...
custom_hooks = [
    dict(
    type='VCNCCompleteWithSpatialHook',
    
    warmup_epochs=1,
    num_classes=20,

    # MUDANÇA: usar logits em vez de softmax
    use_softmax_as_embedding=False,
