...
custom_hooks = [
    ...
    type='VCNCNoisePropagationHook',
        ...
        # Propagação conservadora
        enable_propagation=True,
        propagation_k=3,  # Poucos vizinhos
        propagation_similarity_threshold=0.95,  # Muito similar
        propagation_confidence_threshold=0.9,  # Só alta confiança
        # Ação: Filtrar
