...
custom_imports = dict(
    imports=['custom_configs.hooks.vcnc_features_spatial_hook',
...
custom_hooks = [
    dict(
    type='VCNCFeaturesWithSpatialHook',
    
    warmup_epochs=1,
    num_classes=20,
    
    # Clustering com features
    enable_clustering_relabel=True,
    n_clusters=30,  # C30 teve melhor resultado
    
    # Critérios progressivos (mesmos do C30 original)
