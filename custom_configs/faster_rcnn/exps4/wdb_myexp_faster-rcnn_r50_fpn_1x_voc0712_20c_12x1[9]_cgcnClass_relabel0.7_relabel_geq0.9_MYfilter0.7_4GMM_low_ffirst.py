...
custom_hooks = [
    ...
    dict(type='MyHookGraphNoiseRelabelFilterGMMSanity_invertedClass', priority='NORMAL',
        ...
        max_noise_per_class = max_noise_per_class
    ),
        ...
        high_conf_thr=relabel_thr_high,   # bucket de alto-confiável
