...
custom_imports = dict(
    imports=['custom_configs.hooks.vcnc_features_pca_spatial_hook',
...
custom_hooks = [
    dict(
    type='VCNCFeaturesPCAWithSpatialHook',
    
    warmup_epochs=1,
    num_classes=20,
    
    # PCA
    pca_components=64,  # Reduzir 1024 -> 64
    
    # Clustering
    enable_clustering_relabel=True,
    n_clusters=30,
    
    # Mesmos critérios do C30 original
