...
custom_imports = dict(
    imports=['custom_configs.hooks.vcnc_adaptive_gmm_separation_hook',
...
custom_hooks = [
    dict(
    type='VCNCAdaptiveGMMSeparationHook',
    ...
    # Ranges adaptativos
    anchor_threshold_min=0.15,   # Classes com baixa separação
    anchor_threshold_max=0.45,   # Classes com alta separação
    suspect_threshold_min=0.45,  # Classes com alta separação
    suspect_threshold_max=0.75,  # Classes com baixa separação
