...
custom_hooks = [
    ...
    progressive_epochs=5,
    use_softmax_as_embedding=True,  # Usar softmax como embedding (True) ou logits (False)
    

    
    
    # Critérios MUITO conservadores para épocas iniciais
    early_anchor_gmm_threshold=0.1,       # Ainda mais rígido
    early_anchor_pred_agreement=0.9,      # Ainda mais rígido
    early_anchor_confidence=0.92,
    early_suspect_gmm_threshold=0.85,
    early_similarity_threshold=0.75,
    early_cluster_consensus=0.9,
    
    # Critérios normais para épocas posteriores
