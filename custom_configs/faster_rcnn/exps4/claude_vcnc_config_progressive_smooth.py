...
custom_hooks = [
    ...
    # Critérios iniciais (meio-termo entre conservador e agressivo)
    early_anchor_gmm_threshold=0.25,
    early_anchor_pred_agreement=0.75,
    early_anchor_confidence=0.8,
    early_suspect_gmm_threshold=0.7,
    early_similarity_threshold=0.6,
    early_cluster_consensus=0.75,
    
    # Critérios finais (agressivos)
