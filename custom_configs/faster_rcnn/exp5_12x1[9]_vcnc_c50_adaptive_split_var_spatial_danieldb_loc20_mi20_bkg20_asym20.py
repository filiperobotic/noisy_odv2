...
_base_ = [
    ...
    '../_base_/datasets/voc0712_daniel_loc20_mi20_bkg20_asym20.py',
...
custom_imports = dict(
    imports=['custom_configs.hooks.vcnc_adaptive_variance_hook',
...
custom_hooks = [
    dict(
    type='VCNCAdaptiveVarianceHook',
    
    warmup_epochs=1,
    num_classes=20,
    n_clusters=50,
    
    # Ranges adaptativos (invertido: baixa variância = agressivo)
    anchor_threshold_min=0.15,   # Classes com alta variância
    anchor_threshold_max=0.45,   # Classes com baixa variância
    suspect_threshold_min=0.45,  # Classes com baixa variância
    suspect_threshold_max=0.75,  # Classes com alta variância
