...
custom_imports = dict(
    imports=['custom_configs.hooks.vcnc_complete_with_spatial_with_remain_filter_hook',
...
custom_hooks = [
    dict(
    type='VCNCProgressiveSpatialSelectiveFilterHook',
    
    warmup_epochs=1,
    enable_selective_filtering=True,
    
    selective_filter_gmm_threshold = 0.95,
    selective_filter_confidence_threshold = 0.7,  # NOVO
    num_classes=20,
