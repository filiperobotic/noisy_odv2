...
custom_imports = dict(
    imports=['custom_configs.hooks.vcnc_complete_with_spatial_contamination_hook',
...
custom_hooks = [
    ...
    dict(
    type='VCNCContaminationDetectionHook',
    warmup_epochs=1,
    num_classes=20,
    
    # === DETECÇÃO DE CONTAMINAÇÃO ===
    enable_contamination_detection=True,
    contamination_threshold=0.5,  # 50%
    min_anchors_for_detection=20,
    ...
    diagnostic_output_dir='./vcnc_diagnostics_contam50',
),
    dict(
