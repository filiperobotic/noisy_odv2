...
custom_imports = dict(
    imports=['custom_configs.hooks.vcnc_complete_with_spatial_clusterAnalysis_hook',
...
custom_hooks = [
    dict(
    type='VCNCClusterAnalysisHook',
    warmup_epochs=1,
    num_classes=20,
    
    # === ANÁLISE POR CLUSTER ===
    anchor_ratio_threshold=0.7,  # <70% = simétrico
    top2_concentration_threshold=0.4,  # >40% = assimétrico
    min_cluster_size=5,
    ...
    diagnostic_output_dir='./vcnc_diagnostics_cluster_p1',
),
    dict(
