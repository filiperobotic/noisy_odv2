...
custom_imports = dict(
    imports=['custom_configs.hooks.vcnc_complete_with_spatial_randomL_hook',
...
custom_hooks = [
    dict(
    type='VCNCRandomRelabelingHook',
        warmup_epochs=1,
        num_classes=20,
        margin_threshold=0.2,
        exclude_gt_and_pred=True,  # Random exclui GT e predição
        exclude_dominant=True,      # Random exclui classe dominante do cluster
        n_clusters=30,
