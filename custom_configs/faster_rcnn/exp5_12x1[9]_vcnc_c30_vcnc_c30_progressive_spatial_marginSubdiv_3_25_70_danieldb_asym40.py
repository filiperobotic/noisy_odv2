...
custom_imports = dict(
    imports=['custom_configs.hooks.vcnc_complete_with_spatial_marginSubdiv_hook',
...
custom_hooks = [
    dict(
    type='VCNCAdaptiveSubdivisionHook',
        warmup_epochs=1,
        num_classes=20,
        n_clusters=30,
        ...
        min_cluster_size_for_subdivision=10,
        use_margin_criterion=True,
