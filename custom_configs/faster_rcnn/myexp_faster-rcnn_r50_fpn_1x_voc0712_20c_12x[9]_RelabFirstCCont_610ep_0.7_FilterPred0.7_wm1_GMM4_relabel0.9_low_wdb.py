...
overlap_filter_start=1,    # Começa na época 1
overlap_filter_end=5,     # Termina na época 5
...
custom_hooks = [
    ...
    dict(type='MyHookRFirstCurrIntoFilterPredGT_Class_Relabel', priority='NORMAL',
