...
custom_imports = dict(
    imports=['custom_configs.hooks.vcnc_knn_spatial_hook',
...
custom_hooks = [
    ...
    knn_k=100,                        # Testar: 10, 15, 20
    knn_min_anchors=5,               # Mínimo de âncoras entre vizinhos
    knn_consensus_threshold=0.6,     # Testar: 0.5, 0.6, 0.7
