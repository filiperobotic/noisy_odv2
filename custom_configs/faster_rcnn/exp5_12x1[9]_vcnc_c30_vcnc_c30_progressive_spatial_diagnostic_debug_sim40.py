...
custom_imports = dict(
    imports=['custom_configs.hooks.VCNCClusterDiagnosticHook',
...
custom_hooks = [
    dict(
    type='VCNCClusterDiagnosticHook',
    warmup_epochs=1,
    num_classes=20,
    
    # === CRITÉRIOS (mesmos do cluster analysis) ===
    anchor_ratio_threshold=0.7,
    top2_concentration_threshold=0.3,
    min_cluster_size=5,
    ...
    # === CONFIGURAÇÃO ===
    iou_assigner=0.5,
    diagnostic_epochs=[2, 4, 7, 12],  # Épocas para diagnóstico detalhado
    output_dir='./vcnc_cluster_diagnostic',
