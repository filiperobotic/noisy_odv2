...
custom_hooks = [
    ...
    type='VCNCNoisePropagationHook',
        ...
        # Propagação mais agressiva
        enable_propagation=True,
        propagation_k=10,  # Mais vizinhos
        propagation_similarity_threshold=0.85,  # Threshold menor
        propagation_confidence_threshold=0.7,  # Mais amostras como fonte
        # Ação
